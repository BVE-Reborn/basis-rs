...
bool basisrs_transcode_slice(const basisu_transcoder *me, const void *pData, uint32_t data_size, uint32_t slice_index, void *pOutput_blocks,
    ...
    return me->transcode_slice(pData, data_size, slice_index, pOutput_blocks, output_blocks_buf_size_in_blocks_or_pixels, fmt, output_block_stride_in_bytes, decode_flags, output_row_pitch_in_blocks_or_pixels, pState, pAlpha_blocks, output_rows_in_pixels, channel0, channel1);
}

bool basisrs_transcode_image_level(const basisu_transcoder *me, const void *pData, uint32_t data_size, uint32_t image_index, uint32_t level_index,
                                   void *pOutput_blocks, uint32_t output_blocks_buf_size_in_blocks_or_pixels,
                                   transcoder_texture_format fmt, uint32_t decode_flags,
                                   uint32_t output_row_pitch_in_blocks_or_pixels, basisu_transcoder_state *pState,
                                   uint32_t output_rows_in_pixels) {
    return me->transcode_image_level(pData, data_size, image_index, level_index, pOutput_blocks, output_blocks_buf_size_in_blocks_or_pixels, fmt, decode_flags, output_row_pitch_in_blocks_or_pixels, pState, output_rows_in_pixels);
}
